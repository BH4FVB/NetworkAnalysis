...
csv_file_2011 = '2011_kihon_seisan_37.CSV'
...
for node in G_2011.nodes():
    weighted_degree = sum(G_2011[node][neighbor]['weight'] for neighbor in G_2011.neighbors(node))
    weighted_degree_centrality[node] = weighted_degree

# 将加权中心性指标写入CSV文件
with open('2011_weighted_centrality_metrics.csv', 'w', newline='') as csvfile:
